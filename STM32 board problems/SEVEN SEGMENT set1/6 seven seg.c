// volatile int ZeroToNine[17]={0x77,0x7f,0x39,0x3f,0x79,0x71,0x7d,0x76,0x06,0x38,0x3f,0x73,0x77,0x6d,0x3e,0x6e,0x5b};
...
int main(void)
{
	...
	*pGPIOclken|=(1<<0);                                    //Enabling CLOCK to the GPIO port A
     ...
     while(1)
     	{
     	    for(int8_t i=0;i<17;i=i+1)
            {
                GPIOA->ODR=ZeroToNine[i];
                DELAY();
            }
     	}
}
