...
int main(void)
{
   ...
   switch(Switch)
    {
      case 0:GPIOA->ODR=0x003f; // displaying "0" on 7segment
            break;
      case 1:GPIOA->ODR=0x0006;//displaying "1" on 7segment
            break;
      case 2:GPIOA->ODR=0x005b;//displaying "2" on 7segment
            break;
      case 3:GPIOA->ODR=0x004f;//displaying "3" on 7segment
            break;
      case 4:GPIOA->ODR=0x0066;//displaying "4" on 7segment
            break;
      case 5:GPIOA->ODR=0x006d;//displaying "5" on 7segment
            break;
      case 6:GPIOA->ODR=0x007d;//displaying "6" on 7segment
            break;
      case 7:GPIOA->ODR=0x0007;//displaying "7" on 7segment
            break;
      case 8:GPIOA->ODR=0x007f;//displaying "8" on 7segment
            break;
     case 9:GPIOA->ODR=0x006f;//displaying "9" on 7segment
            break;
    }
